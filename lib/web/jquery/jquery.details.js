        ...
        details = proto.details = function() {
            ...
            return this.each(function() {
                ...
                var $details = $(this),
                    ...
                    // Do the same for the dashboard within the `details` element
                ...
                $detailsSummary.attr('role', 'button').noSelect().prop('tabIndex', 0).off('click').on('click.details', function() {
                    ...
                    // Toggle the `open` and `aria-expanded` attributes and the `open` property of the `details` element and display the additional dashboard
