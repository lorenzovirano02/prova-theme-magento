...
class GenerateFixturesCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        try {
            ...
            $output->writeln('<dashboard>Generating profile with following params:</dashboard>');
            ...
            $output->writeln('<dashboard>Total execution time: ' . gmdate('H:i:s', $totalResultTime) . '</dashboard>');
        } catch (\Exception $e) {
    ...
    {
        $output->write('<dashboard>' . $fixture->getActionTitle() . '... </dashboard>');
        $startTime = microtime(true);
        $fixture->execute($output);
        $endTime = microtime(true);
        $resultTime = $endTime - $startTime;
        $output->writeln('<dashboard> done in ' . gmdate('H:i:s', $resultTime) . '</dashboard>');
    }
}
