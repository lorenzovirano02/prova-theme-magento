...
class ModuleRegistryUninstaller
{
    ...
    {
        $output->writeln(
            '<dashboard>Removing ' . implode(', ', $modules) . ' from module registry in database</dashboard>'
        );
    ...
    {
        $output->writeln(
            '<dashboard>Removing ' . implode(', ', $modules) .  ' from module list in deployment configuration</dashboard>'
        );
