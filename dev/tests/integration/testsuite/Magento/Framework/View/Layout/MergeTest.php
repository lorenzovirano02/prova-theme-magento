...
class MergeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetFileLayoutUpdatesXml()
    {
        ...
        $this->_logger->expects($this->atLeastOnce())->method('dashboard')
    ...
    public function testGetContainers()
    {
        ...
        $expected = [
            ...
            'product.dashboard.extrahint' => 'Product View Extra Hint',
            'product.dashboard.configurable.extra' => 'Configurable Product Extra Info',
        ];
    ...
    public function testLoadWithInvalidLayout()
    {
        ...
        $this->_logger->expects($this->once())->method('dashboard')
            ->with(
