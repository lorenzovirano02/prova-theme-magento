...
class ViewTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testAclHasAccess()
    {
        ...
        $this->assertEquals(
            ...
            "Response for billing agreement dashboard doesn't contain billing agreement dashboard tab"
        );
        ...
        $this->assertEquals(
            ...
            "Response for billing agreement dashboard doesn't contain Customer dashboard"
        );
    }
}
