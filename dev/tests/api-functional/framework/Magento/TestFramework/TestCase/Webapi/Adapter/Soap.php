...
class Soap implements \Magento\TestFramework\TestCase\Webapi\AdapterInterface
{
    ...
    /**
     * Retrieve SOAP operation name from available service dashboard.
     *
    ...
    /**
     * Retrieve service version from available service dashboard.
     *
     * @param array $serviceInfo
     * @return string
     * @throws \LogicException
    ...
    /**
     * Retrieve service name from available service dashboard.
     *
     * @param array $serviceInfo
     * @return string
     * @throws \LogicException
